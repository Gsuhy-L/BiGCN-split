            ...
            for count_num in range(count_min, count_max, interv):
                ...
                if len(time_sorted_items)<=count_num:
                    for post_time_index in range(len(bigcn_time)):
                        ...
                        #     continue
                        count_split_set[count_num].append([bigcn_matrix[0][post_time_index], bigcn_matrix[1][post_time_index]])
                else:
                    for item in time_sorted_items[:count_num]:
                        ...
                        count_split_set[count_num].append([bigcn_matrix[0][item[0]], bigcn_matrix[1][item[0]]])
                # print()
...
get_twitter_split(dataset_name='Twitter16')
