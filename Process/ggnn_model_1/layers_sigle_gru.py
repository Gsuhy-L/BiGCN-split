...
class GraphLayer(nn.Module):
    ...
    def __init__(self,
        ...
        self.gru_unit1 = gru_unit(output_dim = self.output_dim,
                                 act = self.act,
                                 dropout_p = self.dropout_p)

        self.gru_unit2 = gru_unit(output_dim = self.output_dim,
                                 act = self.act,
                                 dropout_p = self.dropout_p)
        # self.dropout
    ...
    def forward(self, feature, root, rootindex, support, mask):
        ...
        output = self.gru_unit1(support, output, mask)
        ...
        output = self.gru_unit2(support, output, mask)
