...
from Process.super_gat.supergat import GATConv
# from Process.super_gat.supergat_model import TdSuperGATNet,BuSuperGATNet
import copy
...
class SuperGatNet(th.nn.Module):
    def __init__(self,in_feats,hid_feats,out_feats):
        super(SuperGatNet, self).__init__()
        self.TDrumorGCN = TDrumorGAT(in_feats, hid_feats, out_feats)
        self.BUrumorGCN = BUrumorGAT(in_feats, hid_feats, out_feats)
...
#
# class SuperGat_Net(th.nn.Module):
#     def __init__(self,in_feats,hid_feats,out_feats):
#         super(SuperGat_Net, self).__init__()
#         self.TDrumorGCN = TdSuperGATNet(in_feats, hid_feats, out_feats)
#         self.BUrumorGCN = BuSuperGATNet(in_feats, hid_feats, out_feats)
#         # self.fc=th.nn.Linear((out_feats+hid_feats)*2,4)
#         self.fc=th.nn.Linear((out_feats)*2,4)
#
#     def forward(self, data):
...
def train_GCN(treeDic, x_test, x_train,TDdroprate,BUdroprate,lr, weight_decay,patience,n_epochs,batchsize,dataname,iter):
    model = SuperGatNet(5000,64,64).to(device)
