...
import copy
from Process.lcat_model.lcat.pyg import GATv1Layer, GATv2Layer
...
class TDrumorGCN(th.nn.Module):
    def __init__(self,in_feats,hid_feats,out_feats):
        ...
        # self.conv1 = GATv1Layer(in_feats,hid_feats,heads=4,concat=False)
...
class LCATNet(th.nn.Module):
    def __init__(self,in_feats,hid_feats,out_feats):
        super(LCATNet, self).__init__()
...
def train_GCN(treeDic, x_test, x_train,TDdroprate,BUdroprate,lr, weight_decay,patience,n_epochs,batchsize,dataname,iter):
    model = LCATNet(5000,64,64).to(device)
